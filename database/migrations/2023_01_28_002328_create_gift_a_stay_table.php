...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('gift_a_stay', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('pay_id')->references('id')->on('lnmo_api_response')->onUpdate('cascade')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('gift_a_stay');
    }
};
