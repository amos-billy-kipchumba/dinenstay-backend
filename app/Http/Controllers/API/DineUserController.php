...
class DineUserController extends Controller
{
    ...
    public function storeUser(Request $request)
    {
        $validator = FacadesValidator::make($request->all(), [
            ...
            'username'=>'required|max:30|unique:dineusers',
        ...
        $user = new DineUser;
            ...
            if($request->hasFile('forward_id'))
            {
                $forward_id = $request->file('forward_id');
                $one = Str::random(32).".".$forward_id->getClientOriginalExtension();
                $forward_id->move('ids/', $one);
                $user->host_front_id = $one;
            }
            ...
            if($request->hasFile('back_id'))
            {
                ...
                $two = Str::random(32).".".$back_id->getClientOriginalExtension();
                $back_id->move('ids/', $two);
                $user->host_back_id = $two;
            }
    ...
    public function storeVenturer(Request $request)
    {
        ...
        $user->phone = $request->input('phone');
        $user->user_type = 2;
        $user->host_front_id = "guest1";
        $user->host_back_id = "guest2";
        $user->save();
    ...
    public function addBlogBlogger(Request $request)
    {
        $validator = FacadesValidator::make($request->all(), [
            'first_name'=>'required|max:30',
            'last_name'=>'required|max:30',
    ...
    {
        $admin= DineUser::where('username',$req->username)->first();
    ...
    public function getGiftedSpecificDetails($id)
    {
        $DineUser = DineUser::where('username', '=', $id)->first();
    ...
    public function updateCustomerProfileDetails(Request $request, $user_id)
    {
        ...
        if($DineUser)
        {
            ...
            $DineUser->username = $request->input('username');
            $DineUser->email = $request->input('email');
            $DineUser->phone = $request->input('phone');
            $DineUser->online = $request->input('online');
            $DineUser->username = $request->input('username');
            $DineUser->user_type = 2;
    ...
    public function updateCustomerOnlineDetails(Request $request, $user_id)
    {
        $DineUser = DineUser::where('id', $user_id)->first();
        if($DineUser)
        {
            ...
            $DineUser->phone = $request->input('phone');
            $DineUser->online = $request->input('online');
            $DineUser->password = $request->input('password');
            $DineUser->user_type = 2;
            $DineUser->update();
    ...
    public function updateBloggerOnlineDetails(Request $request, $user_id)
    {
        $DineUser = DineUser::where('id', $user_id)->first();
        if($DineUser)
        {
    ...
    public function updateAdminOnlineDetails(Request $request, $user_id)
    {
        $DineUser = DineUser::where('id', $user_id)->first();
        if($DineUser)
        {
    ...
    public function updateHostOnlineDetails(Request $request, $user_id)
    {
        $DineUser = DineUser::where('id', $user_id)->first();
        if($DineUser)
        {
