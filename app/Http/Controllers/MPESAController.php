...
class MPESAController extends Controller
{
    ...
    public function b2c(Request $request)
    {
        ...
        $SecurityCredential =  ''; //Security Credentials
        $CommandID =  'SalaryPayment';
        $Amount =  ''; //Amount
        $PartyA =  ''; //Till/PayBill
        $PartyB =  '';  //Customers Number
        $Remarks =  ''; //Remarks
        $QueueTimeOutURL =  'https://domain.com/api/v1/b2c/callbacks';
        $ResultURL =  'https://domain.com/api/v1/b2c/callbacks';
        $Occasion =  ''; //Optionally
        //
